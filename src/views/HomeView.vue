  ...
  <main class="bg-beige">
    ...
    <section class="vh-100 banner">
      <div class="container h-100">
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col-11 col-sm-8 col-md-7 col-lg-10 col-xl-9 col-xxl-8">
            <div class=" text-center row justify-content-center align-items-center mb-6">
              <h1 class="col-lg-6 text-lg-end fw-bolder fs-2 fs-lg-d5 mb-3 mb-lg-0">MeetArt 繪課室</h1>
              <p class="col-lg-6 text-lg-start mb-0 fs-5 fs-lg-2">在繪畫中遇見更好的自己</p>
            </div>
            <div class="mx-xxl-8">
              <div class="d-flex align-items-center bg-light-1 rounded-pill p-1 ps-5 mb-3 mb-lg-4">
                <picture>
                  <source srcset="../assets/images/ic_search_s.png" media="(max-width: 991px)">
                  <source srcset="../assets/images/ic_search.png" media="(min-width: 992px)">
                ...
                <button type="button" class="btn btn-primary rounded-pill py-2 px-3 py-lg-5 px-lg-8 fs-6 fs-lg-4 text-light-1 text-nowrap">搜尋課程</button>
              </div>
              <div>
    ...
    <div class="container">
      ...
      <section class="section-padding">
        <h2 class="fs-2 fs-xl-d5 fw-bolder fw-xl-bold text-center mb-8 mb-md-10 w-fit-content mx-auto pt-5 pt-lg-0 d-md-none d-lg-block">繪課室提供
        ...
        <div class="row justify-content-center icon-wght-300 pt-0 pt-md-9 pt-lg-0">
          <div class="col-md-6 d-none d-md-flex d-lg-none">
            <h2 class="fs-2 fw-bolder text-center w-fit-content m-auto pb-8">繪課室提供
              <span class="gradient-line gradient-line-14 d-block mt-n14"></span>
            </h2>
          </div>
          <div class="col-11 col-sm-9 col-md-6 col-lg-4 mb-8 mb-lg-0">
            <div class="ratio ratio-1x1">
              <div class="gradient-border gradient-border-7 position-absolute rounded-circle d-flex flex-column justify-content-center align-items-center px-8 text-center">
                <span class="material-symbols-outlined text-secondary mb-2 mb-md-4 fs-d0 fs-md-d2 fs-xl-d0">palette</span>
                <h3 class="fs-4 fs-xl-2 fw-semibold fw-xl-bold mb-2 mb-md-4">多元課程</h3>
                <p class="mb-0 fs-xl-5 fw-xl-semibold lh-lg">主題多元、清楚分類<br>找得到心儀課程</p>
              </div>
            </div>
          </div>
          <div class="col-11 col-sm-9 col-md-6 col-lg-4 mb-8 mb-lg-0">
            <div class="ratio ratio-1x1">
              <div class="gradient-border gradient-border-7 position-absolute rounded-circle d-flex flex-column justify-content-center align-items-center px-8 text-center">
                <span class="material-symbols-outlined text-secondary mb-2 mb-md-4 fs-d0 fs-md-d2 fs-xl-d0">support_agent</span>
                <h3 class="fs-4 fs-xl-2 fw-semibold fw-xl-bold mb-2 mb-md-4">課外輔導</h3>
                <p class="mb-0 fs-xl-5 fw-xl-semibold lh-lg">不知道該如何改進？<br>讓老師提供建議</p>
              </div>
            </div>
          </div>
          <div class="col-11 col-sm-9 col-md-6 col-lg-4 pb-5 mb-lg-0">
            <div class="ratio ratio-1x1">
              <div class="gradient-border gradient-border-7 position-absolute rounded-circle d-flex flex-column justify-content-center align-items-center px-8 text-center">
                <span class="material-symbols-outlined text-secondary mb-2 mb-md-4 fs-d0 fs-md-d2 fs-xl-d0">psychology</span>
                <h3 class="fs-4 fs-xl-2 fw-semibold fw-xl-bold mb-2 mb-md-4">課室專欄</h3>
                <p class="mb-0 fs-xl-5 fw-xl-semibold lh-lg">補充滿滿知識內容<br>延伸學習不中斷</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section-padding">
        <div class="row justify-content-center">
          <!-- 左 -->
          <div class="col-md-5 col-lg-6 d-flex flex-column">
            <!-- 上 -->
            <div class="flex-grow-1 pb-lg-3 mb-8 mb-md-0 d-lg-flex">
              <!-- 標題 -->
              <div class="me-sm-8 me-md-6 mb-6">
                <h2 class="fs-2 fs-xl-d5 fw-bolder fw-xl-bold text-center w-fit-content text-nowrap">作品分享
                  <span class="gradient-line gradient-line-14 d-block mt-n14"></span>
                </h2>
                <a class="fs-4 fw-semibold link-secondary text-decoration-none d-flex align-items-center" href="#">
                  看更多
              ...
              <div class="flex-grow-1 d-md-none d-lg-block">
                <div class="h-100 position-relative rounded-3 img-border overflow-hidden hover-animation mx-2 mx-lg-0">
                  ...
                  <div class="position-absolute w-100 bg-black bg-opacity-50 d-flex align-items-center px-6 py-3 py-lg-4 transition-transform-3 translate-y-n100 bottom-fixed-0">
                    <div class="me-3 rounded-circle border border-white border-2 flex-shrink-0" style="width: 62px; height: 62px;">
                      <img class="rounded-circle object-fit-cover w-100 h-100" :src="students[0]?.img" alt="學生">
                    </div>
                    <div>
                      <p class="text-white mb-2 fs-5 fw-semibold">{{ students[0]?.name }}</p>
                      <p class="text-white mb-0 line-clamp-2">我對於繪畫一竅不通，但老師的講解非常詳細，讓我對於線條和形狀的理解更加深入，感謝老師用心教學，讓我能夠在短短的時間內進步如此迅速。</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- 下 -->
            <div class="pt-lg-3 mb-8 mb-lg-0 mh-50">
              <div class="h-100 position-relative rounded-3 img-border overflow-hidden hover-animation mx-2 mx-md-0">
                ...
                <div class="position-absolute w-100 bg-black bg-opacity-50 d-flex align-items-center px-6 py-3 py-lg-4 transition-transform-3 translate-y-n100 bottom-fixed-0">
                  ...
                  <div>
                    <p class="text-white mb-2 fs-5 fw-semibold">{{ students[1]?.name }}</p>
                    <p class="text-white mb-0 line-clamp-2">這堂課程讓我對於色彩的運用有了更多的靈感，讓我的畫作更加生動有趣。老師的教學風格非常活潑，讓我在學習的同時也感到非常開心。我希望未來還有機會參加老師的課程。</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- 右 -->
          <div class="col-md-7 col-lg-6 mb-8 mb-lg-0">
            <div class="h-100 mobile-ratio-3x2 position-relative rounded-3 img-border overflow-hidden hover-animation mx-2 mx-md-0">
              ...
              <div class="position-absolute w-100 bg-black bg-opacity-50 d-flex align-items-center px-6 py-3 py-lg-4 transition-transform-3 translate-y-n100 bottom-fixed-0 rounded-bottom">
                <div class="me-3 rounded-circle border border-white border-2 flex-shrink-0" style="width: 62px; height: 62px;">
                  <img class="rounded-circle object-fit-cover w-100 h-100" :src="students[2]?.img" alt="學生">
                </div>
                <div>
                  <p class="text-white mb-2 fs-5 fw-semibold">{{ students[2]?.name }}</p>
                  <p class="text-white mb-0 line-clamp-2">我一直很喜歡繪畫，但總覺得自己的畫作缺乏靈魂。課程中我學會了如何在畫作中表達情感和個人風格。老師教授的技巧非常實用，讓我在繪畫的時候更加自信。</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="section-padding section-recommend-padding">
      <div class="container">
        <h2 class="fs-2 fs-xl-d5 fw-bolder fw-xl-bold text-center mb-8 mb-md-10 w-fit-content">熱門課程推薦
          <span class="gradient-line gradient-line-14 d-block mt-n14"></span>
        </h2>
      </div>
    ...
    <div class="container">
      <section class="section-padding">
        <h2 class="fs-2 fs-xl-d5 fw-bolder fw-xl-bold text-center mb-8 mb-md-10 w-fit-content">課室專欄
          <span class="gradient-line gradient-line-14 d-block mt-n14"></span>
        </h2>
