<template>
  ...
  <VForm ref="couponForm" v-slot="{ errors, values, resetForm, setValues }" class="row g-5">
    ...
    <div class="col-12">
      ...
      <VField type="text" rules="required" name="title" id="title" class="form-control"></VField>
      <ErrorMessage name="title" class="invalid-feedback d-block"></ErrorMessage>
    </div>
    <div class="col-6">
      <label for="code" class="form-label">折扣碼：</label>
      <VField type="text" rules="required" name="code" id="code" class="form-control"></VField>
      <ErrorMessage name="code" class="invalid-feedback d-block"></ErrorMessage>
    </div>
    <div class="col-6">
      <label for="percent" class="form-label">折數（%）：</label>
      <VField type="number" rules="required|min_value:0|max_value:100" name="percent" id="percent" class="form-control"></VField>
    ...
    <div class="col-12">
      ...
      <DatePicker v-model="date" model-type="timestamp" :format="'yyyy/MM/dd HH:mm:ss'"
                  ...
                  placeholder="請選擇日期與時間" class="form-control"></DatePicker>
